...
function isValidTheme(id) {
  ...
  return chunkJ3GQDTTR_cjs.COLORWAYS.some((c) => c.id === base);
}
function appendHandoffParams(href, options = {}) {
  if (typeof window === "undefined" || !href) return href;
  const themeKey = options.themeStorageKey ?? chunkJ3GQDTTR_cjs.DEFAULT_STORAGE_KEY;
...
//# sourceMappingURL=chunk-S2OOXA4N.cjs.map
//# sourceMappingURL=chunk-S2OOXA4N.cjs.map