...
function isValidTheme(id) {
  ...
  return chunkQEOZBZWT_cjs.COLORWAYS.some((c) => c.id === base);
}
function appendHandoffParams(href, options = {}) {
  if (typeof window === "undefined" || !href) return href;
  const themeKey = options.themeStorageKey ?? chunkQEOZBZWT_cjs.DEFAULT_STORAGE_KEY;
...
//# sourceMappingURL=chunk-FZG3FUMZ.cjs.map
//# sourceMappingURL=chunk-FZG3FUMZ.cjs.map